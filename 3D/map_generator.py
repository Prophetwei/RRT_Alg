...
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parent / "map"
DEFAULT_OUTPUT = DEFAULT_OUTPUT_DIR / "map_0.txt"
    ...
    **kwargs,
    ...
    for index in range(count):
        ...
        generate_dense_3d_map(
            filename=output_dir / f"map_{index}.txt",
            seed=map_seed,
...
def parse_args():
    ...
    parser.set_defaults(ensure_path=True, write_path=True)
